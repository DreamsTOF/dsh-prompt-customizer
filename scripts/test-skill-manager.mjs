/**
 * dsh-prompt-customizer — 技能管理 host 路由回归测试（技能身份 / 导入 / 删除 / 账本自愈）。
 *
...
const sandbox = mkdtempSync(join(tmpdir(), "dsh-prompt-customizer-skills-"))
...
const mod = await import(pathToFileURL(join(process.cwd(), "vendor/skill-manager/skills-host.js")).href)
let handler = null
