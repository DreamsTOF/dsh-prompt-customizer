/**
 * dsh-prompt-customizer — MCP 全局/预设分层回归测试。
 *
...
const sandbox = mkdtempSync(join(tmpdir(), "dsh-prompt-customizer-mcp-"))
...
const maskFile = join(process.env.DSH_HOME, "mcp", "dsh-prompt-customizer", "preset-masks.json")
