...
export const DICT = {
  zh: {
    ...
    syncAllPhases: '三态同步',
    syncAllPhasesHint: '勾选后，屏蔽 / 解除屏蔽对三个阶段一起生效（只作用于同名的那一个工具或提示词段）。默认关闭：三个阶段需逐一处理。',
    broken: '损坏',
  ...
  en: {
    ...
    syncAllPhasesHint: 'When checked, blocking / unblocking applies to the same-named tool or section across all three phases at once. Unchecked (default): handle each phase separately.',
    broken: 'broken',
